//! The runtime: every fiber of the composition, the realms its keys bind in,
//! and the transitions each fiber goes through. [`Ctx`] is what a component
//! holds of it; the lifecycle itself is in `crate::fiber`.
