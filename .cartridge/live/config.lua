return {
  ...
  live = { port = 4317, dir = ".cartridge/live-data", cwd = "..", model = "gpt-live-1", voice = "marin" },
  ...
  harness = { max_bytes = 240 * 1024, output_headroom = 16 * 1024, keep_turns = 4, summary_timeout_secs = 60, ring_keep = 64, ring_sweep = 4 },
  agent = { yolo = true, approval_timeout_secs = 300, cancel_timeout_secs = 5, max_prompt_bytes = 256 * 1024, max_steps = 50, max_tool_calls = 100 },
}
